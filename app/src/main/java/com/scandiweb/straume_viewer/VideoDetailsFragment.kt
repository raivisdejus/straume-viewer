...
class VideoDetailsFragment : DetailsFragment() {
    ...
    private var mSelectedMovie: VideoItem? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mSelectedMovie = activity.intent.getSerializableExtra(DetailsActivity.MOVIE) as VideoItem
    ...
    private fun initializeBackground(movie: VideoItem?) {
